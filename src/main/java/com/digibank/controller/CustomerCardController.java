...
public class CustomerCardController {
	...
	public String cards(@AuthenticationPrincipal CustomUserDetails userDetails, Model model) {
		model.addAttribute("cards", cardService.getCustomerCards(userDetails.getUserId()));
